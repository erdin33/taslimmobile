...
const DashboardPage = lazy(() => import("@/app/desktop/dashboard/page"));
const BarangMasukPage = lazy(() => import("@/app/desktop/barang-masuk/page"));
const BarangKeluarPage = lazy(() => import("@/app/desktop/barang-keluar/page"));
const DataBarangPage = lazy(() => import("@/app/desktop/data-barang/page"));
const DataTransaksiPage = lazy(() => import("@/app/desktop/request/page"));
const DataTransaksiDetailPage = lazy(() => import("@/app/desktop/request/detail/page"));
const LokasiBarangPage = lazy(() => import("@/app/desktop/lokasi-barang/page"));
const TipeMaterialPage = lazy(() => import("@/app/desktop/tipe-material/page"));
const KategoriBarangPage = lazy(() => import("@/app/desktop/kategori-barang/page"));
const MerekBarangPage = lazy(() => import("@/app/desktop/merek-barang/page"));
const MitraPage = lazy(() => import("@/app/desktop/mitra/page"));
const LoginPage = lazy(() => import("@/app/desktop/login/page"));
const PengaturanPage = lazy(() => import("@/app/desktop/pengaturan/page"));
...
const LaporanReconPage = lazy(() => import("@/app/desktop/laporan-recon/page"));
